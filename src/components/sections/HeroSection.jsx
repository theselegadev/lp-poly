      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-6 text-lg text-gray-700">Leve, rápido e pensado para criar jogos em C. Baixe agora e experimente como é aprender a programar de forma leve e divertida.</p>
          ...
          <div className="flex flex-col items-center lg:items-end">
            <div className="w-48 h-48 rounded-lg bg-gray-100 flex items-center justify-center shadow">
